				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="tabs">
						<ul class="nav nav-tabs">
							<li ${search.equals("newed") ? 'class="active"' : '' }><a href="orders.jsp?search=newed">Новые</a></li>
							<li ${search.equals("inprogress") ? 'class="active"' : '' }><a href="orders.jsp?search=inprogress">В обработке</a></li>
							<li ${search.equals("completed") ? 'class="active"' : '' }><a href="orders.jsp?search=completed">Выполненные</a></li>
							<li ${search.equals("rejected") ? 'class="active"' : '' }><a href="orders.jsp?search=rejected">Отклоненные</a></li>
							<li ${(empty search) ? 'class="active"' : '' }><a href="orders.jsp">Все</a></li>
						</ul>
